...
export default function ScrollableHeader() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Change to black when scrolled past 100px
  ...
  return (
    <>
      <header 
        className={`text-white fixed w-full top-0 z-50 shadow-lg transition-colors duration-300 ${
          isScrolled ? 'bg-black' : ''
        }`}
        style={!isScrolled ? { backgroundColor: '#636769' } : {}}
      >
